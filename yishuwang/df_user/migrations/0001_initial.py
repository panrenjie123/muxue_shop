# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-11-12 02:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(default='', max_length=30, verbose_name='年级')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '大学表',
                'verbose_name_plural': '大学表',
            },
        ),
        migrations.AddField(
            model_name='userinfo',
            name='career',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='df_user.Career', verbose_name='专业'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='college',
        ...
        migrations.AddField(
            model_name='userinfo',
            name='university',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='df_user.University', verbose_name='大学'),
        ),
        migrations.AddField(
            model_name='userinfo',
